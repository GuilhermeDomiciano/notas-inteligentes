  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <nav className="flex gap-4 border-b pb-2 text-sm">
        <Link href={`/classes/${id}/tabs/students`} className="hover:underline">Alunos</Link>
        <Link href={`/classes/${id}/tabs/activities`} className="hover:underline">Atividades</Link>
        <Link href={`/classes/${id}/tabs/grades`} className="hover:underline">Lançamentos</Link>
        <Link href={`/classes/${id}/tabs/report`} className="hover:underline">Relatório</Link>
      </nav>
      <div>
        {children}
      </div>
